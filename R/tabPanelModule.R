...
tp2UI <- function(id) {
  ...
  tagList(
    ...
    br(),
    h3("R Squared"),
    withSpinner(plotOutput(ns("Metrics_Plot_r2"), height = "400px")),
    ...
    withSpinner(plotOutput(ns("Metrics_Plot"), height = "600px")),
    ...
    withSpinner(plotOutput(ns("Means_Plot"))),
    ...
    withSpinner(plotOutput(ns("CV_Plot"))),
    ...
    withSpinner(plotOutput(ns('prop_const_plot'))),
